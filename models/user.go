...
var UserWhere = struct {
	...
	AccessToken: whereHelpernull_String{field: "`user`.`access_token`"},
	ExpiredAt:   whereHelpernull_Time{field: "`user`.`expired_at`"},
}
...
var (
	userAllColumns            = []string{"id", "email", "password", "access_token", "expired_at"}
